...
import info.androidhive.slidingmenu.HomeFragment.FemaleFragment;
import info.androidhive.slidingmenu.HomeFragment.maleFragment;
import info.androidhive.slidingmenu.HomeFragment.weddingFragment;
...
@SuppressLint("NewApi") public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.about:
            Toast.makeText(getBaseContext(), "Designed by TechTouch Solutions", Toast.LENGTH_SHORT).show();
            break;
	...
	public void onConfigurationChanged(Configuration newConfig) {
	 ...
	 //force menu bar to appear below
    @Override
