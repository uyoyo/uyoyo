...
public class FindPeopleFragment extends Fragment {
	...
	public FindPeopleFragment(){}
	  private StaggeredGridView mGridView;
		...
		/*@Override
		 public void onCreate(Bundle savedInstanceState) extends Application { super.onCreate(savedInstanceState);
		 Parse.enableLocalDatastore(getActivity());
			 Parse.initialize(getActivity(), "RYBRDnR5gVhVTfWQv0WFVjQHvTGr1VfAQHlnHRZZ", "1rNAIUqp4I0MNAtWsMwHAOT5yH9usSWgzsFxAlPn");
